...
<body>
            ...
            <form method="POST" action="{{route('login')}}">
              ...
              @method('post')
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control @error('password') error-border @enderror" name="password" id="exampleInputPassword1">
                  @error('password')
                  <div class="input-error">
                    <p>{{ $message }}</p>
                  </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      ...
      <!--Dark Mode Switch-->
<div class="themeSwitch" id="themeSwitch" title="Switch Mode"></div>
